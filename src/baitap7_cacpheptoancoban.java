public class baitap7_cacpheptoancoban {
    public static void main(String[] args) {
       ...
       int b=4;
       int c=5;
       System.out.println("(g) 3+4+5/3=" +(a+b+(double)c/a));
       System.out.println("(i) (3+4+5)/3=" +((double)(a+b+c)/a));
       ...
       System.out.println("(o) d1+d2+d3/3=" +(d1+d2+d3/a));
       System.out.println("(p) (d1+d2+d3)/3=" +((d1+d2+d3)/a));
       System.out.println("(q) d1+d2+(d3/3)=" +(d1+d2+(d3/a)));
       System.out.println("(r) 3*(d1+d2)*(d1-d3)=" +(a*(d1+d2)*(d1-d3)));
    }
}
